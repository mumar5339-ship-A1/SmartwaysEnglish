      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-5 py-3.5 sm:px-6">
        <div className="flex items-center gap-3">
          ...
          <div className="leading-tight">
            ...
            <p className="text-[11px] font-500 uppercase tracking-[0.18em] text-brand-600">
        ...
        <button
          onClick={onPractice}
          className="group hidden items-center gap-2 rounded-xl bg-slate-900 px-4 py-2.5 text-sm font-600 text-white shadow-sm transition-all hover:bg-slate-800 hover:shadow-md active:scale-[0.97] sm:flex"
        >
